...
// Ejercicios nuevos que reutilizan un dibujo similar por tipo de movimiento
const ALIAS = {
  'Aperturas con mancuernas': 'Press banca',
  'Press con mancuernas': 'Press banca',
  'Peck deck (contractora)': 'Press en máquina',
  'Flexiones de brazos': 'Press banca',
  'Press en máquina': 'Remo en máquina',
  'Pullover con mancuerna': 'Press banca',
  'Dominadas': 'Jalón al pecho',
  'Remo con mancuerna': 'Remo con barra',
  'Remo en polea baja': 'Remo en máquina',
  'Jalón agarre cerrado': 'Jalón al pecho',
  'Peso muerto rumano': 'Peso muerto',
  'Hiperextensiones': 'Peso muerto',
  'Sentadilla búlgara': 'Sentadilla',
  'Extensión de cuádriceps': 'Prensa',
  'Curl femoral': 'Prensa',
  'Zancadas': 'Sentadilla',
  'Elevación de gemelos': 'Press militar',
  'Hip thrust': 'Peso muerto',
  'Sentadilla goblet': 'Sentadilla',
  'Press Arnold': 'Press militar',
  'Elevaciones frontales': 'Vuelos laterales',
  'Pájaros (posterior)': 'Vuelos laterales',
  'Remo al mentón': 'Press militar',
  'Press militar en máquina': 'Press militar',
  'Encogimientos (trapecio)': 'Vuelos laterales',
  'Curl alternado': 'Curl martillo',
  'Curl en banco inclinado': 'Curl con barra',
  'Curl predicador': 'Curl con barra',
  'Curl en polea': 'Curl con barra',
  'Curl concentrado': 'Curl martillo',
  'Curl araña': 'Curl con barra',
  'Press francés': 'Tríceps en polea',
  'Patada de tríceps': 'Tríceps en polea',
  'Extensión sobre la cabeza': 'Press militar',
  'Tríceps en polea con soga': 'Tríceps en polea',
  'Fondos en banco': 'Fondos',
  'Press cerrado': 'Press banca',
};

export default function Pictograma({ nombre }) {
  return PICTOGRAMAS[nombre] || PICTOGRAMAS[ALIAS[nombre]] || GENERICO;
}
